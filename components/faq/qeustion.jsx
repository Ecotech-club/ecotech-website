...
export default function Qeustion({qst}) {
  ...
  return (
    <div className='flex-1 cursor-pointer my-1.5 mr-20 text-white
    transition duration-200 ease-in transform sm:hover:scale-105 '>
        ...
        <div className='flex  justify-between items-center'>
          ...
          <HiPlusCircle size={70} className='flex-[10%]' color='#DDE226' onClick={() =>setShowAnswer(!showAnswer)}/>
        </div>
          {
            showAnswer  && 
        ...
        <div className='bg-[#DDE226] h-1 w-full  rounded-3xl '></div>         
